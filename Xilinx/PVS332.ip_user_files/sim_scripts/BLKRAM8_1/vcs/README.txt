...
#
# Generated by export_simulation on Sun Oct 27 19:37:51 +0800 2019
#
################################################################################
...
'-reset_run' switch to the './BLKRAM8.sh' script.

./BLKRAM8.sh -reset_run
...
./BLKRAM8.sh -noclean_files

For more information on the script, please type './BLKRAM8.sh -help'.
