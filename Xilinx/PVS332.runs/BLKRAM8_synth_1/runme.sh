...
HD_PWD='D:/Projects/FPGA/PVS332/Xilinx/PVS332.runs/BLKRAM8_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BLKRAM8.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BLKRAM8.tcl
